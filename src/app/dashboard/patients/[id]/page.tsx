...
export default function PatientProfile() {
  ...
  // 3. Delete Attachment (Query Param)
          ...
          <div className="bg-slate-900/50 border border-slate-800 rounded-[1.5rem] md:rounded-[2.5rem] p-6 md:p-8">
            <div className="flex items-center justify-between mb-4 md:mb-6">
                ...
                <button 
                    ...
                    disabled={uploading}
                    className="p-2 bg-slate-800 text-orange-500 rounded-lg hover:bg-orange-500 hover:text-white transition-all"
                >
                  ...
                  {data.treatment_plans?.map((plan: TreatmentPlan) => (
                    <tr key={plan.id} className="hover:bg-slate-800/20 transition-colors">
                      ...
                      <td className="px-6 md:px-8 py-6 text-right">
                        {plan.completed ? (
                            <span className="inline-flex items-center gap-1.5 text-green-500 text-[9px] md:text-[10px] font-black uppercase bg-green-500/10 px-2.5 md:px-3 py-1.5 rounded-full border border-green-500/20">
                                <CheckCircle2 size={12} /> Completed
                            </span>
                        ) : (
                            <span className="inline-flex items-center gap-1.5 text-orange-500 text-[9px] md:text-[10px] font-black uppercase bg-orange-500/10 px-2.5 md:px-3 py-1.5 rounded-full border border-orange-500/20">
